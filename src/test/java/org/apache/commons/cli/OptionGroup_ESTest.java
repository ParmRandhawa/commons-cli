...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("a", "fP");
  ...
  public void test03()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("PmxJ", "gPeV");
      optionGroup0.setSelected(option0);
  ...
  public void test04()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("OGt", "sJd\"]UPhhgB");
      optionGroup0.setRequired(true);
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("PmxJ", "gPeV");
      Option option1 = new Option("gPeV", "gPeV");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup1.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-gPeV gPeV, -PmxJ gPeV]", string0);
  }
  ...
  public void test11()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("owNemJV", "owNemJV");
      optionGroup0.setSelected(option0);
  ...
  public void test13()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("owNemJV", "owNemJV");
      Option option1 = new Option("owPemJV", "owPemJV");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'owNemJV' was specified but an option from this group has already been selected: 'owPemJV'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
